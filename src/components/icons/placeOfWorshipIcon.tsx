import type { IconProps } from '@/models/icons.ts';

export const PlaceOfWorshipIcon = ({fill = '#333', title = 'Place of worship icon', className}: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg"
       viewBox="0 0 640 512"
       role="img"
       aria-labelledby="placeOfWorshipIconTitle"
       aria-hidden="false"
       className={className}
       fill={fill}>
    {/* <!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--> */}
    <title id="placeOfWorshipIconTitle">{title}</title>
    <path
