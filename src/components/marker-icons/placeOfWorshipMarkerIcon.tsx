export const placeOfWorshipMarkerIcon = (fill: string = '#333', title: string = 'Place of worship map marker icon') => (
  `<svg xmlns="http://www.w3.org/2000/svg" 
        viewBox="0 0 640 512"
        role="img"
        aria-labelledby="placeOfWorshipMarkerIconTitle"
        aria-hidden="false"
        fill="${fill}">
     <!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
     <title id="placeOfWorshipMarkerIconTitle">${title}</title>
    <path
